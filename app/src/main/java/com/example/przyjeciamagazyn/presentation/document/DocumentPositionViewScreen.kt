...
@Composable
fun DocumentPositionViewScreen(position: DocumentPosition) {
...
@Composable
fun DocumentPositionViewScreenPreview() {
    PrzyjeciaMagazynTheme {
        DocumentPositionViewScreen(position = sampleDocumentPosition)
    }
}